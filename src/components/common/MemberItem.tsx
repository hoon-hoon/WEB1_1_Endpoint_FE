  ...
  return (
    <div className="flex flex-col space-y-1 items-center justify-end text-center">
      <span className="border border-white rounded-full">
        <Avatar size="S" input="image" image={member.user.imgPath} />
      </span>
      <div className="flex flex-col gap-2 pb-1">
        <span className="text-sm font-medium mb-1 whitespace-nowrap">{member.user.name}</span>

        <Badge variant="secondary" className="mb-1 flex justify-center">
          <span className="font-bold">{member.user.rating}</span>
        </Badge>
